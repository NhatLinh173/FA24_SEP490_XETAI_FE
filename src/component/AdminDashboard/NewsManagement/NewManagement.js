...
const NewManagement = () => {
    const [news, setNews] = useState([
        {
            ...
            date: "01-11-2024",
            author: "Người đăng 1",
            image: "https://interlogistics.com.vn/static/2722/2024/10/15/d%E1%BB%B1%20b%C3%A1o%20c%C6%B0%E1%BB%9Bc%20q4.2024.png",
        }
        ,
        {
            id: "2",
    ...
    const [newItem, setNewItem] = useState({ title: "", content: "", date: "", author: "", image: "" });
    ...
    return (
        <div className="new-management-container mt-5">
            ...
            <Button onClick={() => { setShowAddEditModal(true); resetForm(); }} className="mb-3">
                <FaPlus /> Thêm Tin Tức
            </Button>
                    ...
                    {displayedNews.map((newItem) => (
                        <tr key={newItem.id}>
                            ...
                            <td style={{ textAlign: 'center' }}>
                                {newItem.image && <img src={newItem.image} alt="new" style={{ width: "300px", height: "150px" }} />}
                            </td>
                            <td style={{ textAlign: "center" }}>
            ...
            >
                ...
                <Modal.Header closeButton className="news-modal__header">
                    <Modal.Title className="news-modal__title">
                        {modalAction === "add" ? "Thêm Tin Tức" : "Cập Nhật Tin Tức"}
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body className="news-modal__body">
                        ...
                        <Row>
                            <Col md={6}>
                                <Form.Group controlId="date" className="news-form__group">
                                    <Form.Label className="news-form__label">Ngày đăng</Form.Label>
                                    <Form.Control
                                        type="date"
                                        value={newItem.date}
                            ...
                            <Col md={6}>
                                <Form.Group controlId="author" className="news-form__group">
                                    <Form.Label className="news-form__label">Người đăng</Form.Label>
                                    <Form.Control
                                        type="text"
                    ...
                    {selectedNews && (
                        <div className="news-detail">
                            ...
                            <div className="news-detail-metadata">
                                ...
                                <p className="news-detail-metadata-item">
                                    <span className="news-detail-metadata-label">Người đăng:</span>
                                    {selectedNews.author}
                                </p>
                            </div>
